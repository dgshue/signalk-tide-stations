...
- **Tide station icons** on the chart: **blue up-arrow while the tide is rising, red down-arrow while falling** (the Garmin convention). State is derived from the harmonic prediction curve: next extreme is a High → rising (same rule signalk-tides and OpenCPN use).
- **Current station arrows** rotated to the predicted set (16 pre-rendered 22.5° sectors), orange per the OpenCPN convention, with slack shown as a ring.
